...
const Footer = () => {
  ...
  return (
    <footer className="bg-white px-4 flex flex-col-reverse py-2 b-20 m-0 md:border-t md:border-gray-200 md:py-0 md:flex-row font-semibold items-center">
      ...
      <div className="flex flex-col px-10 m-2 md:p-2 md:flex-row">
        <div className="flex flex-col px-2 py-2 text-center md:py-0">
          Call
          <a className="underline md:pt-1" href="tel:+{16026212059}">
            {footer.call}
          </a>
        </div>
        <div className="flex flex-col px-2 py-2 text-center md:py-0">
          Email
          <a className="underline md:pt-1" href="mailto:abhishri.medewar@outlook.com">
            {footer.email}
          </a>
        </div>
