...
const Resume = () => {
  ...
  const handleView = () => {
    ...
    link.href = process.env.PUBLIC_URL + "/Abhishri_Ajit_Medewar.pdf";
    link.target = "_blank";
  ...
  const handleDownload = () => {
    ...
    const link = document.createElement("a");
    link.href = process.env.PUBLIC_URL + "/Abhishri_Ajit_Medewar.pdf";
    link.download = "Abhishri_Medewar_Resume.pdf"; // Specify the file name you want the user to download as
    ...
    <div className="flex flex-col flex-1 sm:overflow-y-scroll scrollbar-hide">
      <div className="w-full flex p-6 justify-start self-center lg:w-[1000px] xl:w-[1200px]">
        <div className="flex flex-col gap-10 items-center lg:items-start py-4 mb-2 sm:m-2">
          <div className="text-5xl text-left font-normal w-max">Background</div>
          <div className="text-lg font-normal text-justify">{resume.summary}</div>
      ...
      <div className="bg-white flex justify-center">
        <div className=" w-full justify-start self-center lg:w-[1000px] xl:w-[1200px] text-center lg:text-justify flex p-6">
          <div className="flex flex-col gap-10 py-4 items-center lg:items-start mb-2 ">
            <div className="text-5xl font-normal text-left w-max">Education</div>
      ...
      <div className="bg-white flex justify-center my-1">
        <div className="bg-white w-full justify-start self-center lg:w-[1000px] xl:w-[1200px] flex p-6">
          <div className="flex flex-col gap-10 py-4 items-center lg:items-start mb-2  ">
            <div className="text-5xl font-normal text-left w-max">Work</div>
